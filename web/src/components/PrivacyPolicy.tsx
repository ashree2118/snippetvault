        ...
        <div className="flex-1 min-w-0 flex justify-center">
          <div className="max-w-[680px] w-full px-4 py-6 sm:px-5 sm:py-8">
            ...
            <header className="flex justify-between items-center mb-7">
              <Link
                href="/"
                className="text-[22px] font-bold text-[#e8e8e8] tracking-[-0.02em] hover:text-white transition-colors"
              >
                Snippet
              </Link>
              <Link
            ...
            <article className="prose prose-invert max-w-none">
              <h1 className="text-[22px] font-bold text-[#e8e8e8] tracking-[-0.02em] mb-1">
                Privacy Policy
              </h1>
              ...
              <p className="text-[#e0e0e0] text-[15px] leading-relaxed mb-6">
              ...
              <p className="text-[#e0e0e0] text-[15px] leading-relaxed mb-8">
              ...
              <h2 className="text-[17px] font-semibold text-[#e8e8e8] mt-8 mb-3">
              ...
              <h3 className="text-[15px] font-medium text-[#ccc] mt-4 mb-2">
                A. Information You Provide to Us
              </h3>
              <p className="text-[#e0e0e0] text-[15px] leading-relaxed mb-2">
                <strong className="text-[#e0e0e0]">Account Information:</strong> When you log in to use the Service (e.g., using Google authentication), we collect your email address and a unique user identifier to create and manage your account and keep your data synced across devices.
              </p>
              <p className="text-[#e0e0e0] text-[15px] leading-relaxed mb-2">
                <strong className="text-[#e0e0e0]">User Content (Snippets):</strong> The core function of the Service is to save content you select. When you use the extension to save a snippet, we collect and store:
              </p>
              <ul className="list-disc pl-6 text-[#e0e0e0] text-[15px] space-y-1 mb-4">
              ...
              <p className="text-[#e0e0e0] text-[15px] leading-relaxed mb-2">
                <strong className="text-[#e0e0e0]">Technical Usage Data:</strong> Like most web services, our servers automatically collect certain information when you access the dashboard. This may include your IP address, browser type, operating system, and timestamps. This data is used for security, debugging, and maintaining the stability of the Service.
              </p>
              <p className="text-[#e0e0e0] text-[15px] leading-relaxed mb-6">
                <strong className="text-[#e0e0e0]">Cookies and Auth Tokens:</strong> We use essential cookies or local storage tokens solely to maintain your logged-in state so you don&apos;t have to re-authenticate every time you open the extension.
              </p>
              ...
              <ul className="list-disc pl-6 text-[#e0e0e0] text-[15px] space-y-1 mb-2">
              ...
              <ul className="list-disc pl-6 text-[#e0e0e0] text-[15px] space-y-1 mb-6">
                <li><strong className="text-[#e0e0e0]">Hosting &amp; Backend:</strong> Vercel (for hosting the website and API functions).</li>
                <li><strong className="text-[#e0e0e0]">Database:</strong> Vercel Postgres / NeonDB / Supabase (for securely storing your account info and saved snippets).</li>
                <li><strong className="text-[#e0e0e0]">Authentication:</strong> Better Auth (for managing secure logins).</li>
                <li><strong className="text-[#e0e0e0]">AI Processing:</strong> Google Gemini API (for analyzing snippets to generate metadata).</li>
              </ul>
              ...
              <p className="text-[#e0e0e0] text-[15px] leading-relaxed mb-2">
                <strong className="text-[#e0e0e0]">Access &amp; Correction:</strong> You can view and edit all your saved snippets via your dashboard at any time.
              </p>
              <p className="text-[#e0e0e0] text-[15px] leading-relaxed mb-6">
                <strong className="text-[#e0e0e0]">Deletion:</strong> You can delete individual snippets directly in your dashboard. If you wish to delete your entire account and all associated data, please contact us at the email below, and we will promptly remove your data from our systems.
              </p>
              ...
              <p className="text-[#e0e0e0] text-[15px] leading-relaxed mb-8">
                <strong className="text-[#e0e0e0]">GitHub Issues:</strong>{' '}
