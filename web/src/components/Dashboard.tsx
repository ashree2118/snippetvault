...
export default function Dashboard({ initialSnippets }: { initialSnippets: any[] }) {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-[#e0e0e0] font-sans flex overflow-x-auto">
      ...
      {/* Main content */}
      <div className="w-full border-l border-r border-[rgba(255,255,255,0.12)] min-w-0 flex flex-col">
        <div className="flex-1 min-w-0 flex justify-center">
          <div className="max-w-[680px] w-full px-4 py-6 sm:px-5 sm:py-8 flex flex-col flex-1">
